...
import { Database, FileText, Globe, MessageSquare, Radio, Terminal } from 'lucide-react';
...
const connectorColors: Record<string, string> = {
    ...
    console: 'border-yellow-500 bg-yellow-900/30',
    default: 'border-gray-500 bg-gray-900/30',
};

function SinkNode({ data, selected }: NodeProps<SinkNodeData>) {
