...
6. For changes that affect public APIs, wire formats, or performance characteristics, write an Architecture Decision Record (ADR). See the template in the ADR directory.
