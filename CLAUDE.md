...
`make verify-doc`. Equivalent skip toggles work directly on the script:
`SKIP_FMT=1 SKIP_CLIPPY=1 SKIP_AUDIT=1 SKIP_DENY=1 SKIP_DOC=1 bash scripts/verify.sh`.
