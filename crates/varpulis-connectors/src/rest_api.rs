...
impl RestApiConfig {
    /// Create a new REST API configuration with the given base URL.
    ...
    /// Set an API key header for authentication.
...
impl RestApiSink {
    /// Create a new REST API sink that POSTs events to the given path.
