        ...
        Expr::Index {
            ...
            match (&container_val, &index_val) {
                ...
                (Value::Str(s), Value::Int(idx)) => {
                    ...
                    chars.get(idx).map(|c| Value::Str(c.to_string().into()))
                }
                _ => None,
            }
        }
        ...
        Expr::Binary { op, left, right } => {
            ...
            match op {
                ...
                BinOp::Lt => match (&left_val, &right_val) {
                    ...
                    (Value::Timestamp(a), Value::Timestamp(b)) => Some(Value::Bool(a < b)),
                    (Value::Duration(a), Value::Duration(b)) => Some(Value::Bool(a < b)),
                    _ => None,
                },
...
pub fn eval_binary_op(
    ...
    match op {
        BinOp::Gt => match (left, right) {
            ...
            (Value::Timestamp(l), Value::Timestamp(r)) => Some(Value::Bool(l > r)),
